...
![Network Diagram](https://github.com/chronot1995/cumulus-ansible-intermediate-vxlan-j2-2servers/blob/master/documentation/cumulus-ansible-intermediate-vxlan-j2-2servers.png)
...
1. Copy the Git repo to your local machine:
    ...
    ```git clone https://github.com/chronot1995/cumulus-ansible-intermediate-vxlan-j2-2servers```
...
3. Change directories to the following
    ...
    ```cumulus-ansible-intermediate-vxlan-j2-2servers/automation```
